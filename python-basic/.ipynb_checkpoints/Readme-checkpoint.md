...
**목차**
- [ex01 데이터타입](/ex01_데이터타입.ipynb)
- [ex02 데이터구조 리스트](/ex02_데이터구조_리스트.ipynb)
- [ex03 데이터구조 투플](/ex03_데이터구조_투플.ipynb)
- [ex04 데이터구조 딕셔너리](/ex04_데이터구조_딕셔너리.ipynb)
...
**목차**
-[ex05 제어문(조건문과 반복문) 설명](/ex06_제어문(조건문과 반복문)설명.pdf)
-[ex06 제어문](/ex06_제어문.ipynb)
...
**동적 바인딩**: 실행 시간(runtime)에 호출할 메서드(함수)가 결정되는 것
...
**목차**
- [ex11 모듈 import](/ex11_import.ipynb)
